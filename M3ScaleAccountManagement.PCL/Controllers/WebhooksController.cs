...
{
    public partial class WebhooksController: BaseController
    {
        ...
        /// <param name="time">Optional parameter: Example: </param>
        /// <return>Returns the dynamic response from the API call</return>
        public dynamic DeleteAdminApiWebhooksFailuresXml(string accessToken, DateTime? time = null)
        {
            Task<dynamic> t = DeleteAdminApiWebhooksFailuresXmlAsync(accessToken, time);
        ...
        /// <param name="time">Optional parameter: Example: </param>
        /// <return>Returns the dynamic response from the API call</return>
        public async Task<dynamic> DeleteAdminApiWebhooksFailuresXmlAsync(string accessToken, DateTime? time = null)
        {
            ...
            _queryBuilder.Append("/admin/api/webhooks/failures.xml");
        ...
        /// <param name="accessToken">Required parameter: Example: </param>
        /// <return>Returns the dynamic response from the API call</return>
        public dynamic GetAdminApiWebhooksFailuresXml(string accessToken)
        {
            Task<dynamic> t = GetAdminApiWebhooksFailuresXmlAsync(accessToken);
            APIHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        /// <param name="accessToken">Required parameter: Example: </param>
        /// <return>Returns the dynamic response from the API call</return>
        public async Task<dynamic> GetAdminApiWebhooksFailuresXmlAsync(string accessToken)
        {
            //the base uri for api requestss
            string _baseUri = Configuration.BaseUri;
